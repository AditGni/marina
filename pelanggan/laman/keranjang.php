	...
	<?php } else {
		...
		<div class="card my-2">
			<div class="card-body">
				<div class="row">
					<?php
					$sql = mysql_query("SELECT b.id,a.nama_barang,a.harga,b.jumlah FROM tbproduk a, tbkeranjang b, tbstok c WHERE a.id=b.kode_pro AND a.id=c.id_poroduk AND b.kode_pel='$idp' ORDER BY 1");
					$item = 0;
					$tot = 0;
						...
						<div class="col-md-4">
							...
							<div class="card-text text-center">
								...
								<div class="btn-group mt-3">
									<button class="btn btn-warning"><i class="fa fa-minus"></i></button>									
